...
const errorMessages = {
  ...
  unknown: "Something went wrong. Try again or enter the recipe manually.",
};
      ...
      {(state.stage === "input" || state.stage === "loading") && (
        <div className="flex flex-col gap-4">
          <p style={{ color: "var(--muted)" }}>
            Paste the link to any recipe page and we&apos;ll fill in the details for you.
          </p>
          <input
            type="url"
            value={url}
      ...
      {state.stage === "review" && (
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <div>
              <p className="font-semibold" style={{ color: "#15803d" }}>Recipe imported!</p>
